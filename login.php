  ...
  if (!isset($_SESSION['userid'])) {
    if (isset($_POST['submit'])) {
      ...
      if (!empty($user_username) && !empty($user_password)) {
        ...
        $query = "SELECT userid, username, firstname FROM theshopuser WHERE username = '$user_username' AND pswd = SHA('$user_password')";
        ...
        if (mysqli_num_rows($data) == 1) {
          ...
          $error_msg = '<p class="mirror">Sorry, you must enter a valid username and password to log in.</p>';
        }
      }
      else {
        // The username/password weren't entered so set an error message
        $error_msg = '<p class="mirror">Sorry, you must enter your username and password to log in.</p>';
      }
    }
  }
?>
...
<body>
  <h1 class="centerh1 white">Log In</h1>
...
?>
  <div class="formblock">
    ...
    <form class="formlines" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
        ...
        <input placeholder="1234passw0rd" type="password" name='password' id='password'/><br>
        <input type="submit" value="Log In" name="submit" class="spacing buttonset"/>      
      <p class="forgetfont"><a href="forgetmenot.php">Forgot password?</a>></p>
    </form>
