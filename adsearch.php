...
<?php  
  ...
  <nav>
  <form action="adsearch.php" method="get"  class="navi">
  <span class="space">  
  ...
  <form action='' id='loadfeatures' method='post' class="graydisplay">
      <div>
        <span class="red" onclick="showLoader(1);" >Load Feature</span>   
      </div>
      <br>
  </form>
  ...
  <form class="graydisplay">
      <div >
        <span><a href="adsearch.php" class="red">Refresh</a></span>
      </div>
      <br>
  </form>
...
<div class="recorder" id="recorder">
    <form enctype="multipart/form-data" id="myFormLoader" method="post" action="adsearch.php" > 
      
      <input type="hidden" name="stockide" value="<?php if (!empty($stockide)) echo $stockide; ?>">

      <label>Stock Name:</label><input type="text" id="workoutblue" class="workoutblue" required name="stockname" value="<?php if (!empty($stockname)) echo $stockname; ?>"><br>
      ...
      <label>Retail price:</label><input type="text" required name="retailprice" value="<?php if (!empty($retailprice)) echo $retailprice; ?>">
      <label>Cost price:</label><input type="text" required name="costprice" value="<?php if (!empty($costprice)) echo $costprice; ?>"><br>
